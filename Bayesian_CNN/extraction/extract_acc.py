...
with open("alexnet/diagnostics_NonBayesalexnet_cifar100.txt", 'r') as file:
    acc = re.findall(r"'Accuracy':\s+tensor\((.*?)\)", file.read())
print(acc)
...
with open("alexnet/diagnostics_NonBayesalexnet_mnist.txt", 'r') as file:
    acc = re.findall(r"'Accuracy':\s+tensor\((.*?)\)", file.read())
print(acc)
...
with open("alexnet/diagnostics_NonBayesalexnet_stl10.txt", 'r') as file:
    acc = re.findall(r"'Accuracy':\s+tensor\((.*?)\)", file.read())
print(acc)
...
with open("alexnet/diagnostics_Bayesalexnet_cifar100.txt", 'r') as file:
    acc = re.findall(r"'Accuracy':\s+tensor\((.*?)\)", file.read())
print(acc)
...
with open("alexnet/diagnostics_Bayesalexnet_mnist.txt", 'r') as file:
    acc = re.findall(r"'Accuracy':\s+tensor\((.*?)\)", file.read())
print(acc)
...
with open("alexnet/diagnostics_Bayesalexnet_stl10.txt", 'r') as file:
    acc = re.findall(r"'Accuracy':\s+tensor\((.*?)\)", file.read())
print(acc)
...
plt.savefig("results_alexnet.png")
